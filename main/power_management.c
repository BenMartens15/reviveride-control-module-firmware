...
#define BLIND_SPOT_L_EN_PIN 12
#define BLIND_SPOT_R_EN_PIN 14
#define DASH_CAM_EN_PIN 33
#define BACKUP_CAM_EN_PIN 32
#define HEAD_UNIT_SHUTDOWN_PIN 18
#define DASH_CAM_SHUTDOWN_PIN 19
